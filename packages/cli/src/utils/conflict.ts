 ...
 */
export function detectConflicts(targetDir: string, cwd: string = process.cwd()): ConflictResult {
  ...
  const files = readdirSync(absolutePath, { recursive: true, withFileTypes: true })
